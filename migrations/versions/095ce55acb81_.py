...
Revision ID: 095ce55acb81
Revises: eb49b4bad811
Create Date: 2020-06-03 11:43:28.263727
...
revision = '095ce55acb81'
down_revision = 'eb49b4bad811'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # sa.Column('tasks', sa.JsonCustomType(), nullable=True),
