...
class BaseConfig(object):
    ...
    # username = doadmin
    # password = t2eb5uywriodwuhm
    # host = db-postgresql-nyc1-32554-do-user-7536213-0.a.db.ondigitalocean.com
    # port = 25060
    # database = defaultdb
    # sslmode = require
    ...
    # MAIL_USE_TLS = False
    # MAIL_USE_SSL = True
    # MAIL_USERNAME = 'testusr5055@gmail.com' 
    # MAIL_PASSWORD = 'james_bon007'
    
    # MAIL_DEFAULT_SENDER = 'testusr5055@gmail.com' 
    
    MAIL_SERVER ='mail.gandi.net'
    MAIL_PORT = 465  
    MAIL_USE_TLS = False
    MAIL_USE_SSL = True
    MAIL_USERNAME = 'system@menatee.net'
    MAIL_PASSWORD = 'GetGlean3167*'
    MAIL_DEFAULT_SENDER = 'system@menatee.net'
...
class DevelopmentConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql://root:root@localhost:3306/mentorship'
    # BaseConfig.build_db_uri()
    MOCK_EMAIL = False
...
class StagingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql://doadmin:mvfxguhb980mnl4c@db-postgresql-nyc1-40714-do-user-7536213-0.a.db.ondigitalocean.com:25060/membershipdb?sslmode=require'
    # BaseConfig.build_db_uri()
    MOCK_EMAIL = False
